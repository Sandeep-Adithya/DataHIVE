...
class Manager_teacher:
    ...
    def __init__(self,root):
        ...
        self.marks_btn=Button(self.topbar,text="Marks",width=8,height=2,fg="white",bd=1,activebackground="#4da6ff",bg="#000817",command=lambda: self.show_frame(students_marks))
        self.detials_btn=Button(self.topbar,text="Detials",width=8,height=2,fg="white",bd=1,activebackground="#4da6ff",bg="#000817",command=lambda: self.show_frame(students_detials))
...
class time_table(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self.Frame2,text="CLASS",background="#ecf0f5").pack(side=LEFT)
        ...
        Label(self.Frame2,text="SECTION",background="#ecf0f5").pack(side=LEFT)
...
class report_card(Frame):
    def __init__(self, parent, controller):
        ...
        Label(self.Frame2,text="Admission Number",background="#ecf0f5").pack(side=LEFT)
        ...
        self.ncs_frm = Frame(self,background="#ecf0f5")
